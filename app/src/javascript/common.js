...
const passDesign = document.getElementById('cached-pass')
window.encryption.updateCachedSecret(async (event, result) => {
  if(result) passDesign.style.backgroundColor = "green";
