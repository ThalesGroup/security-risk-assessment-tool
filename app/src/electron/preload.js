...
contextBridge.exposeInMainWorld('welcome', {
  ...
  getConfig: () => ipcRenderer.invoke('welcome:getConfig'),
  updateConfigOrg: (data) => ipcRenderer.invoke('welcome:updateConfigOrg', data),
});
...
contextBridge.exposeInMainWorld('risks', {
  ...
  addRiskVulnerabilityRef: (riskId, riskAttackPathId, vulnerabilityId) => ipcRenderer.invoke('risks:addRiskVulnerabilityRef', riskId, riskAttackPathId, vulnerabilityId),
...
contextBridge.exposeInMainWorld('encryption', {
  setSecret: (secret,save) => ipcRenderer.send('set-secret', secret,save),
