...
const renderVulnerabilities = () => {
    ...
    const tableOptions = {
      ...
      columns: [ // Define Table Columns
        {
          title: 'Vuln. Id', field: 'vulnerabilityId', width: 100, headerSort: false, headerHozAlign: 'center',
        },
        {
        ...
        {
          title: 'Vuln. Level', field: 'overallLevel', headerSort: false, headerHozAlign: 'center',
        },
      ],
    };
