...
describe('Populate class values (valid & invalid)', () => {
  ...
  test('set projectURL', () => {
    ...
    expect(projectContext.projectURL).toBe('ftp://server/pathname');
  ...
  test('set ProjectContext newDecode', () => {
    projectContext.useNewDecode = false;
    expect(projectContext.useNewDecode).toBe(false);

    projectContext.useNewDecode = true;
    expect(projectContext.useNewDecode).toBe(true);

    expect(() => {
      projectContext.useNewDecode = 'string';
    }).toThrow();
  });
  ...
  test('set projectNameRef', () => {
    ...
    expect(risk.projectNameRef).toBe('name');

    risk.projectNameRef = '';
    expect(risk.projectNameRef).toBe('');
  ...
  test('set projectVersionRef', () => {
    risk.projectVersionRef = 'version';
    expect(risk.projectVersionRef).toBe('version');

    risk.projectVersionRef = '';
    expect(risk.projectVersionRef).toBe('');
  ...
  test('set riskIdRef', () => {
    ...
    expect(riskName.riskIdRef).toBe(null);

    riskName.riskIdRef = 1;
    expect(riskName.riskIdRef).toBe(1);
  ...
  test('set riskName', () => {
    ...
    expect(riskName.riskName).toBe('name');

    riskName.riskName = '';
    expect(riskName.riskName).toBe('');
  ...
  test('set threatAgent', () => {
    ...
    testValues.forEach((testValue) => {
      ...
      expect(riskName.threatAgent).toBe(testValue);
    });
  ...
  test('set threatAgentDetail', () => {
    ...
    expect(riskName.threatAgentDetail).toBe('<p style="color:blue>project description</p>');

    riskName.threatAgentDetail = '<img src="pic_trulli.jpg" alt="Italian Trulli/">';
    expect(riskName.threatAgentDetail).toBe('<img src="pic_trulli.jpg" alt="Italian Trulli/">');

    riskName.threatAgentDetail = '';
    expect(riskName.threatAgentDetail).toBe('');
  ...
  test('set threatVerb', () => {
    ...
    testValues.forEach((testValue) => {
      ...
      expect(riskName.threatVerb).toBe(testValue);
    });
  ...
  test('set threatVerbDetail', () => {
    ...
    expect(riskName.threatVerbDetail).toBe('<p style="color:blue>project description</p>');

    riskName.threatVerbDetail = '<img src="pic_trulli.jpg" alt="Italian Trulli/">';
    expect(riskName.threatVerbDetail).toBe('<img src="pic_trulli.jpg" alt="Italian Trulli/">');

    riskName.threatVerbDetail = '';
    expect(riskName.threatVerbDetail).toBe('');
  ...
  test('set motivation', () => {
    ...
    expect(riskName.motivation).toBe('motivation');

    riskName.motivation = '';
    expect(riskName.motivation).toBe('');
  ...
  test('set motivationDetail', () => {
    ...
    expect(riskName.motivationDetail).toBe('<p style="color:blue>project description</p>');

    riskName.motivationDetail = '<img src="pic_trulli.jpg" alt="Italian Trulli/">';
    expect(riskName.motivationDetail).toBe('<img src="pic_trulli.jpg" alt="Italian Trulli/">');

    riskName.motivationDetail = '';
    expect(riskName.motivationDetail).toBe('');
  ...
  test('set businessAssetRef', () => {
    ...
    expect(riskName.businessAssetRef).toBe(null);

    riskName.businessAssetRef = businessAsset.businessAssetId;
    expect(riskName.businessAssetRef).toBe(1);
  ...
  test('set supportingAssetRef', () => {
    ...
    expect(riskName.supportingAssetRef).toBe(null);

    riskName.supportingAssetRef = supportingAsset.supportingAssetId;
    expect(riskName.supportingAssetRef).toBe(1);
  ...
  test('set isAutomaticRiskName', ()=>{
    riskName.isAutomaticRiskName = false;
    expect(riskName.isAutomaticRiskName).toBe(false);

    riskName.isAutomaticRiskName = true;
    expect(riskName.isAutomaticRiskName).toBe(true);

    expect(() => {
      riskName.isAutomaticRiskName = 0;
    }).toThrow();

    expect(() => {
      riskName.isAutomaticRiskName = '1';
    }).toThrow();
  });
  ...
  test('set mitigationsBenefits', () => {
    ...
    expect(riskMitigation.mitigationsBenefits).toBe(null);

    riskMitigation.mitigationsBenefits = 11.1;
    expect(riskMitigation.mitigationsBenefits).toBe(11.1);
  ...
  test('set mitigationsDoneBenefits', () => {
    ...
    expect(riskMitigation.mitigationsDoneBenefits).toBe(null);

    riskMitigation.mitigationsDoneBenefits = 11.1;
    expect(riskMitigation.mitigationsDoneBenefits).toBe(11.1);
  ...
  test('set projectNameRef', () => {
    ...
    expect(vulnerability.projectNameRef).toBe('name');

    vulnerability.projectNameRef = '';
    expect(vulnerability.projectNameRef).toBe('');
  ...
  test('set projectVersionRef', () => {
    ...
    expect(vulnerability.projectVersionRef).toBe('version');

    vulnerability.projectVersionRef = '';
    expect(vulnerability.projectVersionRef).toBe('');
  ...
  test('set vulnerabilityTrackingURI', () => {
    ...
    expect(vulnerability.vulnerabilityTrackingURI).toBe('ftp://server/pathname');
  ...
  test('set vulnerabilityRef', () => {
    riskAttackPath.addVulnerability({
      vulnerabilityIdRef: israProject.getVulnerability(1).vulnerabilityId,
  ...
  test('set rowId', ()=> {
    riskAttackPath.rowId = 1;
    expect(riskAttackPath.rowId).toBe(1);
    ...
    expect(() => {
      riskAttackPath.rowId = null;
    }).toThrow();
  });

  test('set Vulnerability newDecode', () => {
    vulnerability.useNewDecode = false;
    expect(vulnerability.useNewDecode).toBe(false);

    vulnerability.useNewDecode = true;
    expect(vulnerability.useNewDecode).toBe(true);
  ...
  test('delete Risk', () => {
    ...
    expect(() => {
      israProject.getRisk(1).getRiskAttackPath(1).getVulnerability(1);
    }).toThrow();
