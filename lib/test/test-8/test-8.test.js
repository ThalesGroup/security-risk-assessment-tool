...
describe('Populate class values (valid & invalid)', () => {
  ...
  test('get ISRAproject', async () => {
    ...
    const result = await israProject.toJSON();
  ...
  test('set businessAssetProperties', () => {
    ...
    businessAsset.businessAssetProperties
      .businessAssetIdRef = businessAsset.businessAssetId;
  ...
  test('set SupportingAsset', async () => {
    israProject.addSupportingAsset(supportingAsset);
    expect(JSON.parse(await israProject.toJSON()).SupportingAsset).toEqual([{
      supportingAssetId: 1,
  ...
  test('set riskLikelihood', () => {
    ...
    risk.riskLikelihood.riskIdRef = risk.riskId;
  ...
  test('set riskImpact', () => {
    ...
    risk.riskImpact.riskIdRef = risk.riskId;
  ...
  test('set riskMitigation', () => {
    ...
    risk.getRiskMitigation(1).riskIdRef = risk.riskId;
  ...
  test('get ISRAProject properties', async () => {
    const proj = {
      ISRAmeta: {
        appVersion: undefined,
        projectName: '',
    ...
    expect(JSON.parse(await israProject.toJSON())).toEqual(proj);
  });
  ...
  test('delete SupportingAsset', () => {
    ...
    israProject.getSupportingAsset(1).deleteBusinessAssetRef(1);
