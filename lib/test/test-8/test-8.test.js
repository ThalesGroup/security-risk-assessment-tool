...
describe('Populate class values (valid & invalid)', () => {
  ...
  test('set projectVersionRef', () => {
    ...
    expect(risk.properties.projectVersionRef).toBe('version');

    risk.projectVersionRef = '';
    expect(risk.properties.projectVersionRef).toBe('');
  ...
  test('set description', () => {
    ...
    expect(riskMitigation.properties.description).toBe('<p style="color:blue>project description</p>');

    riskMitigation.description = '<img src="pic_trulli.jpg" alt="Italian Trulli/">';
    expect(riskMitigation.properties.description).toBe('<img src="pic_trulli.jpg" alt="Italian Trulli/">');

    riskMitigation.description = '';
    expect(riskMitigation.properties.description).toBe('');
  ...
  test('set vulnerabilityName', () => {
    ...
    expect(vulnerability.properties.vulnerabilityName).toBe('name');

    vulnerability.vulnerabilityName = '';
    expect(vulnerability.properties.vulnerabilityName).toBe('');
