...
describe('Populate class values (valid & invalid)', () => {
  ...
  test('set ISRAMetaTracking', () => {
    ...
    expect(israProject.properties.ISRAmeta.ISRAtracking[0])
      .toEqual({
        trackingIteration: 1,
  ...
  test('set BusinessAsset', () => {
    ...
    expect(israProject.properties.BusinessAsset[0]).toEqual({
      businessAssetId: 1,
  ...
  test('get businessAsset', () => {
    ...
    expect(israProject.getBusinessAsset(1).properties).toEqual(expect.objectContaining(ba));
    expect(israProject.getBusinessAsset(1).properties.businessAssetProperties.properties)
      .toEqual(expect.objectContaining(bap));
  });
  ...
  test('set riskImpact', () => {
    ...
    risk.properties.riskImpact.riskIdRef = risk.properties.riskId;

    expect(risk.properties.riskImpact.properties).toEqual({
      riskIdRef: 1,
      riskImpact: undefined,
  ...
  test('set projectVersionRef', () => {
    vulnerability.projectNameRef = 'version';
    expect(vulnerability.properties.projectNameRef).toBe('version');
  ...
  test('set supportingAssetRef', () => {
    ...
    expect(vulnerability.properties.supportingAssetRef.has(1)).toBe(true);
