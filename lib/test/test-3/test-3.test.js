...
describe('XML is newly created, class values are valid', () => {
  ...
  describe('get BusinessAsset', () => {
    ...
    test('get BusinessAsset', () => {
      expect(ISRAProjectData.getBusinessAsset(1).properties).toEqual(ba1);
    });
  });
  ...
  describe('get Risk', () => {
    ...
    test('get Risk', () => {
      expect(ISRAProjectData.getRisk(1).properties).toEqual(risk1);
    });
  });
  ...
  describe('get Vulnerability', () => {
    ...
    test('get vulnerability1', () => {
      expect(ISRAProjectData.getVulnerability(1).properties).toEqual(v1);
    });
  });
});
