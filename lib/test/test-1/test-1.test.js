...
describe('XML is an empty form, class values are valid', () => {
  ...
  // test('Test each value in test-1.xml', async () => {
  //   await XML2JSON('./lib/test/test-1/test-1.xml', israProject);
  ...
  //   expect(jsonTest).toEqual(israProject.properties);
  // });

  XML2JSON('./lib/test/test-1/test-1.xml', israProject);
