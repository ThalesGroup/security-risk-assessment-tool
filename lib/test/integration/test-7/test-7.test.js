...
describe('XML is partially filled, class values are valid', () => {
  const result = XML2JSON('./test/integration/fixtures/test-7.xml');
  const israProject = result.project;
  ...
  test('reports cleanup for empty supporting asset references and invalid tracking URI', () => {
  ...
  describe('get Vulnerability', () => {
    ...
    const v2 = {
      ...
      projectVersion: '',
      vulnerabilityId: 2,
      vulnerabilityName: 'Please name Vulnerability 2',
      vulnerabilityFamily: 'Environmental Vulnerability',
      vulnerabilityTrackingID: '',
      vulnerabilityTrackingURI: '',
      vulnerabilityDescription: '',
      vulnerabilityDescriptionAttachment: '',
      vulnerabilityCVE: 'https://www.google.com/',
      cveScore: null,
      overallScore: null,
      overallLevel: 'Low',
      supportingAssetRef: [1],
