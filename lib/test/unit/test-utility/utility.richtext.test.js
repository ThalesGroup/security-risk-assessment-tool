...
// __tests__/utility.richtext.test.js
...
// Adjust the relative path to wherever utility.js lives in your repo
// Example assumes src/model/risks/utility.js exports getHTMLString
...
describe('getHTMLString rich-text extraction is robust for empty and self-closing elements', () => {
  ...
  describe('whitespace and attributes do not break parsing', () => {
    ...
    test('empty pair with whitespace yields empty', () => {
      ...
      `;
      const v = getHTMLString(xmlEmpty, 'decisionDetail', 1);
      expect(v).toBe('');
    });
  });
});
