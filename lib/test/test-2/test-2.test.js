...
describe('XML is fully filled, class values are valid', () => {
  ...
  describe('get BusinessAsset', () => {
    ...
    test.each([
      [ISRAProjectData.getBusinessAsset(ba1.businessAssetId).properties, ba1],
      [ISRAProjectData.getBusinessAsset(ba2.businessAssetId).properties, ba2],
      [ISRAProjectData.getBusinessAsset(ba3.businessAssetId).properties, ba3],
  ...
  describe('get SupportingAsset', () => {
    ...
    test.each([
      [ISRAProjectData.getSupportingAsset(sa1.supportingAssetId).properties, sa1],
      [ISRAProjectData.getSupportingAsset(sa2.supportingAssetId).properties, sa2],
      [ISRAProjectData.getSupportingAsset(sa3.supportingAssetId).properties, sa3],
      [ISRAProjectData.getSupportingAsset(sa4.supportingAssetId).properties, sa4],
  ...
  describe('get Risk', () => {
    ...
    test.each([
      ...
      [ISRAProjectData.getRisk(risk3.riskId).properties, risk3],
      [ISRAProjectData.getRisk(risk4.riskId).properties, risk4],
  ...
  describe('get Vulnerability', () => {
    ...
    test.each([
      ...
      [ISRAProjectData.getVulnerability(v3.vulnerabilityId).properties, v3],
      [ISRAProjectData.getVulnerability(v4.vulnerabilityId).properties, v4],
      [ISRAProjectData.getVulnerability(v5.vulnerabilityId).properties, v5],
