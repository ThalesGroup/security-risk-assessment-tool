...
describe('XML is fully filled, class values are valid', () => {
  ...
  describe('get ISRAmeta', () => {
    ...
    test('get businessAssetsCount', () => {
      expect(ISRAmeta.businessAssetsCount).toBe(Array.from(BusinessAsset).length);
    });

    test('get supportingAssetsCount', () => {
      expect(ISRAmeta.supportingAssetsCount).toBe(Array.from(SupportingAsset).length);
    });

    test('get risksCount', () => {
      expect(ISRAmeta.risksCount).toBe(Array.from(Risk).length);
    });

    test('get vulnerabilitiesCount', () => {
      expect(ISRAmeta.vulnerabilitiesCount).toBe(Array.from(Vulnerability).length);
    });
  });
  ...
  describe('get ProjectContext', () => {
    test('get projectDescription', () => {
      ...
      // expect(isBase64(ProjectContext.projectDescription)).toBe(/src="data:image\/png;base64,iVBORw0KGgoAAAANSUhEUgAABaUAAAC6CAYAAAC/);
    ...
    test('get projectDescriptionAttachment', () => {
      expect(isBase64(ProjectContext.projectDescriptionAttachment)).toBe(true);
    });
  ...
  describe('get Risk', () => {
    ...
    describe('get risk2', () => {
      const risk2 = {
        ...
        riskManagementDetail: 'Risk accepted by Product Owner on 2020-11-24.',
        residualRiskScore: 0,
    ...
    describe('get risk3', () => {
      const risk3 = {
        ...
        riskName: {
          ...
          threatVerbDetail: '',
          motivation: 'get the user credentials to be able to login through the web interface and do financial transactions',
          motivationDetail: 'The threat agent looks over the shoulder while the person is entering their credentials.',
          businessAssetRef: 1,
        ...
        riskManagementDetail: 'Risk transferred to users, with application help  indicating that displaying of sensitive information should be protected from prying eyes and users should be aware of their surroundings.',
    ...
    describe('get risk4', () => {
      const risk4 = {
        ...
        riskManagementDecision: 'Mitigate',
        riskManagementDetail: 'Risk reduced through implementation of hardware backed storage.',
      ...
      const riskMitigation1 = {
        riskIdRef: 4,
        riskMitigationId: 1,
        description: 'Encrypt the local storage on the device by using a diversified key from a random generated on the device.',
        benefits: 0.25,
        cost: null,
        decision: '',
        decisionDetail: '',
      ...
      const riskMitigation2 = {
        riskIdRef: 4,
        riskMitigationId: 2,
        description: 'Use hardware-backed encryption available on the device.',
        benefits: 0.75,
        cost: null,
        decision: 'Done',
        decisionDetail: 'Usage of secure enclave on iOS and hardware backed keystore on Android.',
        mitigationsBenefits: 0.25,
        mitigationsDoneBenefits: 0.25,
      };
  ...
  describe('get Vulnerability', () => {
    ...
    test('get vulnerability1', () => {
      ...
      expect(isBase64(vulnerability.get(1).properties.vulnerabilityDescriptionAttachment))
        .toBe(true);
    });
