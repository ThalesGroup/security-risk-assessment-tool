...
describe('XML is fully filled, class values are valid', () => {
  ...
  describe('get ISRAmeta', () => {
    ...
    describe('get ISRAtracking', () => {
      ...
      test('get israTracking 1', () => {
        expect(ISRAProjectData.getMetaTracking(1).properties).toEqual(israTracking1);
      });
      ...
      test('get israTracking 2', () => {
        expect(ISRAProjectData.getMetaTracking(2).properties).toEqual(israTracking2);
      });
      ...
      test('get israTracking 3', () => {
        expect(ISRAProjectData.getMetaTracking(3).properties).toEqual(israTracking3);
      });
    });
  ...
  //     expect(isValidHtml(ProjectContext.properties.projectDescription)).toBe(true);
  //   });
  ...
  //     expect(isValidAttachment(ProjectContext.properties.projectDescriptionAttachment)).toBe(true);
  //   });

  //   test('get securityProjectObjectives', () => {
  //     expect(ProjectContext.properties.securityProjectObjectives).toBe('<div xmlns="http://www.w3.org/1999/xhtml" align="center"><em>Test</em></div>');
  //   });

  //   test('get securityOfficerObjectives', () => {
  //     expect(ProjectContext.properties.securityOfficerObjectives).toBe('<strong xmlns="http://www.w3.org/1999/xhtml">Test</strong>');
  //   });

  //   test('get securityAssumptions', () => {
  //     expect(ProjectContext.properties.securityAssumptions).toBe('<div xmlns="http://www.w3.org/1999/xhtml">&lt;dfgdg&gt;</div>'
  ...
  // describe('get Risk', () => {
  //   const Risk1 = israProject.getRisk(1).properties;
  //   const Risk2 = israProject.getRisk(2).properties;
  //   const Risk3 = israProject.getRisk(3).properties;
  //   const Risk4 = israProject.getRisk(4).properties;
