...
class ISRAProject {
  ...
  */
  ...
  constructor() {
    ...
    this.#targetedLevelOfTrust = jsonSchema.targetedLevelOfTrust.default;
  ...
  */
  ...
  /** targeted level of trust for assessment
    * @type {string}
  */
  set targetedLevelOfTrust(targetedLevelOfTrust) {
    if (isTargetedLevelOfTrust(targetedLevelOfTrust)) this.#targetedLevelOfTrust = targetedLevelOfTrust;
    else throw new Error('Targeted Level of Trust is invalid');
  }

  get targetedLevelOfTrust() {
    return this.#targetedLevelOfTrust;
  }
  ...
  get properties() {
    return {
      ISRAmeta: {
        ...
        targetedLevelOfTrust: this.#targetedLevelOfTrust,
