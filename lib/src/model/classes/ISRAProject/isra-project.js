...
class ISRAProject {
  ...
  */
  ...
  constructor() {
    this.#appVersion = jsonSchema.appVersion.default;
  ...
  */
  addSupportingAsset(supportingAsset) {
    if (supportingAsset instanceof SupportingAsset) {
      ...
      this.#latestSupportingAssetId += 1;
  ...
  */
  addRisk(risk) {
    if (risk instanceof Risk) {
      const r = risk;
      r.projectNameRef = this.#projectName;
      r.projectVersionRef = this.#projectVersion;
  ...
  */
  addVulnerability(vulnerability) {
    if (vulnerability instanceof Vulnerability) {
      ...
      v.projectNameRef = this.#projectName;
      v.projectVersionRef = this.#projectVersion;
      this.#vulnerabilitiesMap.set(
        v.vulnerabilityId,
        v,
      );
      this.#vulnerabilitiesCount = this.#vulnerabilitiesMap.size;
      this.#latestVulnerabilityId += 1;
