...
class ISRAProject {
  ...
  */
  ...
  get businessAssetsCount() {
    return this.#businessAssetsCount;
  }

  get supportingAssetsCount() {
    return this.#supportingAssetsCount;
  }

  get risksCount() {
    return this.#risksCount;
  }

  get vulnerabilitiesCount() {
