...
class ISRAProject {
  ...
  */
  ...
  set targetedLevelOfTrust(targetedLevelOfTrust) {
    if (isTargetedLevelOfTrust(targetedLevelOfTrust)) {
      this.#targetedLevelOfTrust = targetedLevelOfTrust;
    } else throw new Error('Targeted level of trust is an invalid string');
  }
