...
const BusinessAssetPropertiesJsonSchema = require('../../schema/json-schema').properties.BusinessAsset.items.properties.businessAssetProperties.properties;
...
class BusinessAssetProperties {
  ...
  constructor() {
    this.#businessAssetConfidentiality = BusinessAssetPropertiesJsonSchema
      .businessAssetConfidentiality.default;
    this.#businessAssetIntegrity = BusinessAssetPropertiesJsonSchema
      .businessAssetIntegrity.default;
    this.#businessAssetAvailability = BusinessAssetPropertiesJsonSchema
      .businessAssetAvailability.default;
    this.#businessAssetAuthenticity = BusinessAssetPropertiesJsonSchema
      .businessAssetAuthenticity.default;
    this.#businessAssetAuthorization = BusinessAssetPropertiesJsonSchema
      .businessAssetAuthorization.default;
    this.#businessAssetNonRepudiation = BusinessAssetPropertiesJsonSchema
      .businessAssetNonRepudiation.default;
  }
  ...
  */
  set businessAssetIdRef(businessAssetIdRef) {
    if (isBusinessAssetId(businessAssetIdRef)) {
