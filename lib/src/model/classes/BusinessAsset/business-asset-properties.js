...
module.exports = class BusinessAssetProperties {
  ...
  set businessAssetConfidentiality(businessAssetConfidentiality) {
    ...
    || businessAssetConfidentiality === null) {
      ...
      throw new Error(`Business asset ${this.#businessAssetIdRef}: confidentiality is not an integer or invalid`);
    }
  }
  ...
  set businessAssetIntegrity(businessAssetIntegrity) {
    ...
    || businessAssetIntegrity === null) {
      ...
      throw new Error(`Business asset ${this.#businessAssetIdRef}: integrity is not an integer or invalid`);
    }
  }
  ...
  set businessAssetAvailability(businessAssetAvailability) {
    ...
    || businessAssetAvailability === null) {
      ...
      throw new Error(`Business asset ${this.#businessAssetIdRef}: availability is not an integer or invalid`);
    }
  }
  ...
  set businessAssetAuthenticity(businessAssetAuthenticity) {
    ...
    || businessAssetAuthenticity === null) {
      ...
      throw new Error(`Business asset ${this.#businessAssetIdRef}: authenticity is not an integer or invalid`);
    }
  }
  ...
  set businessAssetAuthorization(businessAssetAuthorization) {
    ...
    || businessAssetAuthorization === null) {
      ...
      throw new Error(`Business asset ${this.#businessAssetIdRef}: authorization is not an integer or invalid`);
    }
  }
  ...
  set businessAssetNonRepudiation(businessAssetNonRepudiation) {
    ...
    || businessAssetNonRepudiation === null) {
      ...
      throw new Error(`Business asset ${this.#businessAssetIdRef}: nonrepudiation is not an integer or invalid`);
    }
  }
