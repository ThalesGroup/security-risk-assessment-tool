...
module.exports = class BusinessAssetProperties {
  ...
  set businessAssetIdRef(businessAssetIdRef) {
    if (Number.isSafeInteger(businessAssetIdRef) || businessAssetIdRef === null) {
      ...
      throw new Error(`Business asset ${this.#businessAssetIdRef}: id ref is not an integer`);
    }
  }
  ...
  set businessAssetConfidentiality(businessAssetConfidentiality) {
    ...
    || businessAssetConfidentiality === null) {
      ...
      throw new Error(`Business asset ${this.#businessAssetIdRef}: confidentiality is not an integer or is invalid`);
    }
  }
  ...
  set businessAssetIntegrity(businessAssetIntegrity) {
    ...
    || businessAssetIntegrity === null) {
      ...
      throw new Error(`Business asset ${this.#businessAssetIdRef}: integrity is not an integer or is invalid`);
    }
  }
  ...
  set businessAssetAvailability(businessAssetAvailability) {
    ...
    || businessAssetAvailability === null) {
      ...
      throw new Error(`Business asset ${this.#businessAssetIdRef}: availability is not an integer or is invalid`);
    }
  }
  ...
  set businessAssetAuthenticity(businessAssetAuthenticity) {
    ...
    || businessAssetAuthenticity === null) {
      ...
      throw new Error(`Business asset ${this.#businessAssetIdRef}: authenticity is not an integer or is invalid`);
    }
  }
  ...
  set businessAssetAuthorization(businessAssetAuthorization) {
    ...
    || businessAssetAuthorization === null) {
      ...
      throw new Error(`Business asset ${this.#businessAssetIdRef}: authorization is not an integer or is invalid`);
    }
  }
  ...
  set businessAssetNonRepudiation(businessAssetNonRepudiation) {
    ...
    || businessAssetNonRepudiation === null) {
      ...
      throw new Error(`Business asset ${this.#businessAssetIdRef}: nonrepudiation is not an integer or is invalid`);
    }
  }
