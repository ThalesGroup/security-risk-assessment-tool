...
module.exports = class BusinessAsset {
  ...
  set businessAssetType(businessAssetType) {
    if (typeof businessAssetType === 'string') this.#businessAssetType = businessAssetType;
    else throw new Error(`Business asset ${this.#businessAssetId}: type is not a string`);
  }
