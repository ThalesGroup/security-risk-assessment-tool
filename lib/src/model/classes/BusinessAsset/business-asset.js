...
const { businessAssetTypeEnums } = require('./enum');
...
module.exports = class BusinessAsset {
  ...
  set businessAssetId(businessAssetId) {
    if ((Number.isSafeInteger(businessAssetId)
    && businessAssetId > 0)
  ...
  set businessAssetType(businessAssetType) {
    if (businessAssetType in businessAssetTypeEnums) this.#businessAssetType = businessAssetType;
