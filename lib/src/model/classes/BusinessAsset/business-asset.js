...
module.exports = class BusinessAsset {
  ...
  set businessAssetDescription(businessAssetDescription) {
    if (typeof businessAssetDescription === 'string' && isValidHtml(businessAssetDescription)) this.#businessAssetDescription = businessAssetDescription;
    else throw new Error(`Business asset ${this.#businessAssetId}: description is not a html string`);
  }
