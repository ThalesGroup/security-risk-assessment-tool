...
module.exports = class RiskMitigation {
  ...
  set benefits(benefits) {
    ...
    else throw new Error(`Risk ${this.#riskIdRef}: ${this.#riskMitigationId}: benefits is not null/double or is invalid`);
  }
  ...
  set mitigationsBenefits(mitigationsBenefits) {
    ...
    } else throw new Error(`Risk ${this.#riskIdRef}: ${this.#riskMitigationId}: mitigations benefits is not null/double`);
  }
  ...
  set mitigationsDoneBenefits(mitigationsDoneBenefits) {
    ...
    } else throw new Error(`Risk ${this.#riskIdRef}: ${this.#riskMitigationId}: mitigations done benefits is not null/double`);
  }
