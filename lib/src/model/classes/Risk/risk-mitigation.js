...
/**
  ...
  * @throws mitigation : (riskMitigationId): description is not a html string
  * @throws mitigation : (riskMitigationId): benefits is an invalid null/double
  * @throws mitigation : (riskMitigationId): cost is not null/integer
  * @throws mitigation : (riskMitigationId): decision is invalid
*/
class RiskMitigation {
  ...
  */
  set description(description) {
    ...
    else throw new Error(`mitigation: ${this.#riskMitigationId}: description is not a html string`);
  }
  ...
  */
  set benefits(benefits) {
    ...
    else throw new Error(`mitigation: ${this.#riskMitigationId}: benefits is an invalid null/double`);
  }
  ...
  /**  numerical input of cost
    * @type {integer|null}
  */
  set cost(cost) {
    if (isCost(cost)) this.#cost = cost;
    else throw new Error(`mitigation: ${this.#riskMitigationId}: cost is not null/double`);
  }
  ...
  */
  set decision(decision) {
    ...
    else throw new Error(`mitigation:  ${this.#riskMitigationId}: decision is invalid`);
  }
  ...
  */
  set decisionDetail(decisionDetail) {
    ...
    else throw new Error(`mitigation: ${this.#riskMitigationId}: decision detail is not a string`);
  }
