...
class RiskMitigation {
  ...
  */
  set benefits(benefits) {
    ...
    else throw new Error(`Risk ${this.#riskIdRef}: mitigation: ${this.#riskMitigationId}: benefits is an invalid null/double`);
  }
  ...
  */
  set cost(cost) {
    ...
    else throw new Error(`Risk ${this.#riskIdRef}: mitigation: ${this.#riskMitigationId}: cost is not null/double`);
  }
  ...
  */
  set decision(decision) {
    ...
    else throw new Error(`Risk ${this.#riskIdRef}: mitigation:  ${this.#riskMitigationId}: decision is invalid`);
  }
  ...
  */
  set decisionDetail(decisionDetail) {
    ...
    else throw new Error(`Risk ${this.#riskIdRef}: mitigation: ${this.#riskMitigationId}: decision detail is not a string`);
  }
