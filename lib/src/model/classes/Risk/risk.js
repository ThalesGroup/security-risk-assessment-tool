...
module.exports = class Risk {
  ...
  set riskManagementDecision(riskManagementDecision) {
    ...
    else throw new Error(`Risk ${this.#riskId}: management decision is not a string or is invalid`);
  }
  ...
  set residualRiskLevel(residualRiskLevel) {
    ...
    else throw new Error(`Risk ${this.#riskId}: residual risk level is not a string or is invalid`);
  }
