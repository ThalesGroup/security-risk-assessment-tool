...
module.exports = class Risk {
  ...
  set riskManagementDecision(riskManagementDecision) {
    if (typeof riskManagementDecision === 'string') this.#riskManagementDecision = riskManagementDecision;
  ...
  set residualRiskLevel(residualRiskLevel) {
    if (typeof residualRiskLevel === 'string') this.#residualRiskLevel = residualRiskLevel;
