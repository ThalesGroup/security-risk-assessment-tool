...
module.exports = class RiskAttackPath {
  ...
  addVulnerability(vulnerability) {
    if (typeof vulnerability === 'object') this.#vulnerabilityMap.set(vulnerability.vulnerabilityIdRef, vulnerability);
  ...
  set attackPathScore(attackPathScore) {
    if (Number.isSafeInteger(attackPathScore) || attackPathScore === null) {
      this.#attackPathScore = attackPathScore;
    } else throw new Error(`Risk ${this.#riskIdRef}: attack path: ${this.#riskAttackPathId}: attack path score is not an integer`);
  }
