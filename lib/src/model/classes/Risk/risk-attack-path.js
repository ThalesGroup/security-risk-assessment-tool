...
class RiskAttackPath {
  ...
  */
  addVulnerability(vulnerability) {
    if (isVulnerabilityRef(vulnerability)) {
      this.#vulnerabilityMap.set(vulnerability.refId, vulnerability);
  ...
  */
  deleteVulnerability(refId) {
    if (this.#vulnerabilityMap.has(refId)) {
      this.#vulnerabilityMap.delete(refId);
