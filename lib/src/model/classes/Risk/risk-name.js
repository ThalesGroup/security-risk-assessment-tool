...
/**
  ...
  * @throws risk name is not an string
  * @throws threat agent is invalid
  * @throws threat agent detail is not a html string
  * @throws threat verb is invalid
  * @throws threat verb detail is not a html string
  * @throws motivation is not a string
  * @throws motivation detail is not a html string
  * @throws business asset ref is not null/integer
  * @throws supporting asset ref is not null/integer
  * @throws isAutomaticRiskName is not a boolean
*/
class RiskName {
  // #riskIdRef;
  ...
  */
  set riskName(riskName) {
    ...
    else throw new Error(`risk name is not an string`);
  }
  ...
  */
  set threatAgent(threatAgent) {
    ...
    else throw new Error(`threat agent is invalid`);
  }
  ...
  */
  set threatAgentDetail(threatAgentDetail) {
    ...
    else throw new Error(`threat agent detail is not a html string`);
  }
  ...
  */
  set threatVerb(threatVerb) {
    ...
    else throw new Error(`threat verb is invalid`);
  }
  ...
  */
  set threatVerbDetail(threatVerbDetail) {
    ...
    else throw new Error(`threat verb detail is not a html string`);
  }
  ...
  */
  set motivation(motivation) {
    ...
    else throw new Error(`motivation is not a string`);
  }
  ...
  */
  set motivationDetail(motivationDetail) {
    ...
    else throw new Error(`motivation detail is not a html string`);
  }
  ...
  */
  set businessAssetRef(businessAssetRef) {
    ...
    } else throw new Error(`business asset ref is not null/integer`);
  }
  ...
  */
  set supportingAssetRef(supportingAssetRef) {
    ...
    } else throw new Error(`supporting asset ref is not null/integer`);
  }
