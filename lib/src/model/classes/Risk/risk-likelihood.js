...
module.exports = class RiskLikelihood {
  ...
  set riskLikelihoodDetail(riskLikelihoodDetail) {
    if (typeof riskLikelihoodDetail === 'string' && isValidHtml(riskLikelihoodDetail)) this.#riskLikelihoodDetail = riskLikelihoodDetail;
  ...
  set threatFactorLevel(threatFactorLevel) {
    if (threatFactorLevel in threatFactorLevelEnum) this.#threatFactorLevel = threatFactorLevel;
    else throw new Error(`Risk ${this.#riskIdRef}: threat factor level is invalid`);
  }
  ...
  set occurrenceLevel(occurrenceLevel) {
    if (occurrenceLevel in occurrenceLevelEnum) this.#occurrenceLevel = occurrenceLevel;
    else throw new Error(`Risk ${this.#riskIdRef}: occurrence level is invalid`);
  }
