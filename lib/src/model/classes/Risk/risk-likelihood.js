...
/**
  ...
  * @throws risk likelihood is an invalid null/integer
  * @throws risk likelihood is an invalid null/integer
  * @throws risk likelihood detail is invalid html string
  * @throws skill level is an invalid null/integer
  * @throws reward is an invalid null/integer
  * @throws access resources is an invalid null/integer
  * @throws size is an invalid null/integer
  * @throws intrusion detection is an invalid null/integer
  * @throws threat factor score is not a null/double
  * @throws threat factor level is invalid string
  * @throws occurrence is an invalid null/integer
  * @throws occurrence level is invalid string
  * @throws isOWASPLikelihood is not a boolean
*/
class RiskLikelihood {
  ...
  */
  set riskLikelihood(riskLikelihood) {
    ...
    } else throw new Error(`risk likelihood is an invalid null/integer`);
  }
  ...
  */
  set riskLikelihoodDetail(riskLikelihoodDetail) {
    ...
    } else throw new Error(`risk likelihood detail is invalid html string`);
  }
  ...
  */
  set skillLevel(skillLevel) {
    ...
    else throw new Error(`skill level is an invalid null/integer`);
  }
  ...
  */
  set reward(reward) {
    ...
    else throw new Error(`reward is an invalid null/integer`);
  }
  ...
  */
  set accessResources(accessResources) {
    ...
    } else throw new Error(`access resources is an invalid null/integer`);
  }
  ...
  */
  set size(size) {
    ...
    else throw new Error(`size is an invalid null/integer`);
  }
  ...
  */
  set intrusionDetection(intrusionDetection) {
    ...
    } else throw new Error(`intrusion detection is an invalid null/integer`);
  }
  ...
  */
  set threatFactorScore(threatFactorScore) {
    ...
    else throw new Error(`threat factor score is not a null/double`);
  }
  ...
  */
  set threatFactorLevel(threatFactorLevel) {
    ...
    else throw new Error(`threat factor level is invalid string`);
  }
  ...
  */
  set occurrence(occurrence) {
    ...
    else throw new Error(`occurrence is an invalid null/integer `);
  }
  ...
  */
  set occurrenceLevel(occurrenceLevel) {
    ...
    else throw new Error(`occurrence level is invalid string`);
  }
