...
module.exports = class RiskImpact {
  ...
  set businessAssetConfidentialityFlag(businessAssetConfidentialityFlag) {
    ...
    } else throw new Error(`Risk ${this.#riskIdRef}: business asset confidentiality flag is not an integer`);
  }
  ...
  set businessAssetIntegrityFlag(businessAssetIntegrityFlag) {
    ...
    } else throw new Error(`Risk ${this.#riskIdRef}: business asset integrity flag is not an integer`);
  }
  ...
  set businessAssetAvailabilityFlag(businessAssetAvailabilityFlag) {
    ...
    } else throw new Error(`Risk ${this.#riskIdRef}: business asset availability flag is not an integer`);
  }
  ...
  set businessAssetAuthenticityFlag(businessAssetAuthenticityFlag) {
    ...
    } else throw new Error(`Risk ${this.#riskIdRef}: business asset authenticity flag is not an integer`);
  }
  ...
  set businessAssetAuthorizationFlag(businessAssetAuthorizationFlag) {
    ...
    } else throw new Error(`Risk ${this.#riskIdRef}: business asset authorization flag is not an integer`);
  }
  ...
  set businessAssetNonRepudiationFlag(businessAssetNonRepudiationFlag) {
    ...
    } else throw new Error(`Risk ${this.#riskIdRef}: business asset nonrepudiation flag is not an integer`);
  }
