...
const riskImpactJsonSchema = require('../../schema/json-schema').properties.Risk.items.properties.riskImpact.properties;

/**
  * Create a RiskImpact with private members: Impact evaluation section to calculate riskImpact
  * @throws risk impact is an invalid null/integer
  * @throws business asset confidentiality flag is an invalid null/integer
  * @throws business asset integrity flag is an invalid null/integer
  * @throws business asset availability flag is an invalid null/integer
  * @throws business asset authenticity flag is an invalid null/integer
  * @throws business asset authorization flag is an invalid null/integer
  * @throws business asset non-repudiation flag is an invalid null/integer
*/
class RiskImpact {
  // #riskIdRef;
  ...
  constructor() {
    this.#riskImpact = riskImpactJsonSchema.riskImpact.default;
    this.#businessAssetConfidentialityFlag = riskImpactJsonSchema
      .businessAssetConfidentialityFlag.default;
    this.#businessAssetIntegrityFlag = riskImpactJsonSchema
      .businessAssetIntegrityFlag.default;
    this.#businessAssetAvailabilityFlag = riskImpactJsonSchema
      .businessAssetAvailabilityFlag.default;
    this.#businessAssetAuthenticityFlag = riskImpactJsonSchema
      .businessAssetAuthenticityFlag.default;
    this.#businessAssetAuthorizationFlag = riskImpactJsonSchema
      .businessAssetAuthorizationFlag.default;
    this.#businessAssetNonRepudiationFlag = riskImpactJsonSchema
      .businessAssetNonRepudiationFlag.default;
  }
  ...
  */
  set riskImpact(riskImpact) {
    if (isRiskImpact(riskImpact)) this.#riskImpact = riskImpact;
    else throw new Error(`risk impact is not null/integer`);
  }
  ...
  */
  set businessAssetConfidentialityFlag(businessAssetConfidentialityFlag) {
    ...
    } else throw new Error(`business asset confidentiality flag is an invalid null/integer`);
  }
  ...
  */
  set businessAssetIntegrityFlag(businessAssetIntegrityFlag) {
    ...
    } else throw new Error(`business asset integrity flag is an invalid null/integer`);
  }
  ...
  */
  set businessAssetAvailabilityFlag(businessAssetAvailabilityFlag) {
    ...
    } else throw new Error(`business asset availability flag is an invalid null/integer`);
  }
  ...
  */
  set businessAssetAuthenticityFlag(businessAssetAuthenticityFlag) {
    ...
    } else throw new Error(`business asset authenticity flag is an invalid null/integer`);
  }
  ...
  */
  set businessAssetAuthorizationFlag(businessAssetAuthorizationFlag) {
    ...
    } else throw new Error(`business asset authorization flag is an invalid null/integer`);
  }
  ...
  */
  set businessAssetNonRepudiationFlag(businessAssetNonRepudiationFlag) {
    ...
    } else throw new Error(`business asset nonrepudiation flag is an invalid null/integer`);
  }
