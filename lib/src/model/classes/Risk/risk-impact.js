...
module.exports = class RiskImpact {
  ...
  set riskImpact(riskImpact) {
    ...
    else throw new Error(`Risk ${this.#riskIdRef}: risk impact is not an integer`);
  }
  ...
  set businessAssetConfidentialityFlag(businessAssetConfidentialityFlag) {
    ...
    } else throw new Error(`Risk ${this.#riskIdRef}: business asset confidentiality flag is not null/integer or is invalid`);
  }
  ...
  set businessAssetIntegrityFlag(businessAssetIntegrityFlag) {
    ...
    } else throw new Error(`Risk ${this.#riskIdRef}: business asset integrity flag is not null/integer or is invalid`);
  }
  ...
  set businessAssetAvailabilityFlag(businessAssetAvailabilityFlag) {
    ...
    } else throw new Error(`Risk ${this.#riskIdRef}: business asset availability flag is not null/integer or is invalid`);
  }
  ...
  set businessAssetAuthenticityFlag(businessAssetAuthenticityFlag) {
    ...
    } else throw new Error(`Risk ${this.#riskIdRef}: business asset authenticity flag is not null/integer or is invalid`);
  }
  ...
  set businessAssetAuthorizationFlag(businessAssetAuthorizationFlag) {
    ...
    } else throw new Error(`Risk ${this.#riskIdRef}: business asset authorization flag is not null/integer or is invalid`);
  }
  ...
  set businessAssetNonRepudiationFlag(businessAssetNonRepudiationFlag) {
    ...
    } else throw new Error(`Risk ${this.#riskIdRef}: business asset nonrepudiation flag is not null/integer or is invalid`);
  }
