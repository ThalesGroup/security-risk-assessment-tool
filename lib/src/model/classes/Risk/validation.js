...
/** validate isTransferredFromDependency in Risk
    * @param {boolean} val value intended to be populated into
    * isTransferredFromDependency class property
    * @returns {boolean}
  */
const isTransferredFromDependency = (val) => {
  const subSchema = jsonSchemaRisk.isTransferredFromDependency;
  return validateClassProperties(val, subSchema);
};

/** validate dependencyOrigin in Risk
    * @param {string} val value intended to be populated into
    * dependencyOrigin class property
    * @returns {boolean}
  */
const isDependencyOrigin = (val) => {
  const subSchema = jsonSchemaRisk.dependencyOrigin;
  return validateClassProperties(val, subSchema);
};
...
/** validate decision detail in RiskMitigation
    * @param {string} val value intended to be populated into
