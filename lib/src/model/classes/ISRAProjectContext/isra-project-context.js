...
const projCxtSchema = require('../../schema/json-schema').properties.ProjectContext.properties;
...
class ISRAProjectContext {
  ...
  constructor() {
    this.#useNewDecode = projCxtSchema.useNewDecode.default;
  }
  ...
  */
  ...
  /** verify if project context attachment uses old (from previous xml risk tool) or new decoding method
  ...
  */
  set useNewDecode(boolean) {
    ...
    } else throw new Error('Project Context: useNewDecode value is not a boolean');
  }
  ...
  */
  get properties() {
    return {
      ...
      useNewDecode: this.#useNewDecode
    };
  }
}
