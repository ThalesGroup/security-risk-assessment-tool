...
module.exports = class ISRAProjectContext {
  ...
  set projectDescriptionAttachment(projectDescriptionAttachment) {
    if (typeof projectDescriptionAttachment === 'string') this.#projectDescriptionAttachment = projectDescriptionAttachment;
  ...
  static #isValidAttachment(projectDescAttachment) {
    ...
    return pattern.test(projectDescAttachment) || projectDescAttachment === null;
  }
