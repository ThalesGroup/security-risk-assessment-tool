...
/** validate attachment decoding method in ISRAProjectContext & Vlnerabilities
    * @param {boolean} val value intended to be populated into
    * useNewDecode class property
    * @return {boolean}
  */
const isUseNewDecode = (val) => {
  const subSchema = jsonSchema.useNewDecode;
  return validateClassProperties(val, subSchema);
};
