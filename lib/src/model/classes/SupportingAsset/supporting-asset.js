...
class SupportingAsset {
  ...
  constructor() {
    ...
    this.#supportingAssetName = `Please name Supporting Asset ${this.#supportingAssetId}`;
  ...
  */
  ...
  /** input name of supporting asset
    * @type {string}
  */
  ...
  */
  deleteBusinessAssetRef(index) {
    ...
    } else throw new Error(`Supporting asset ${this.#supportingAssetId}: business asset ref at index ${index} doesn't exist, failed to delete`);
  }
  ...
  */
  updateBusinessAssetRef(index, value) {
    ...
    } else throw new Error(`Supporting asset ${this.#supportingAssetId}: business asset ref at index ${index} doesn't exist, failed to update`);
  }
