...
module.exports = class SupportingAsset {
  ...
  set supportingAssetId(supportingAssetId) {
    if ((Number.isSafeInteger(supportingAssetId)
    && supportingAssetId > 0)
  ...
  set supportingAssetSecurityLevel(supportingAssetSecurityLevel) {
    ...
    && isSupportingAssetSecurityLevel(supportingAssetSecurityLevel))
  ...
  deleteBusinessAssetRef(businessAssetId) {
    ...
    } else throw new Error(`Supporting asset ${this.#supportingAssetId}: business asset ref deson't exist`);
  }
