...
module.exports = class SupportingAsset {
  ...
  set supportingAssetType(supportingAssetType) {
    if (typeof supportingAssetType === 'string') this.#supportingAssetType = supportingAssetType;
    else throw new Error(`Supporting asset ${this.#supportingAssetId}: type is not a string`);
  }
  ...
  set supportingAssetSecurityLevel(supportingAssetSecurityLevel) {
    ...
    } else throw new Error(`Supporting asset ${this.#supportingAssetId}: security level is not an integer`);
  }
  ...
  get properties() {
    return {
      ...
      businessAssetRefs: Array.from(this.#businessAssetRefs),
    };
  }
};
