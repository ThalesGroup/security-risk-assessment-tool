  ...
  properties: {
    ISRAmeta: {
      ...
      properties: {
        ...
        targetedLevelOfTrust: {
          type: 'string',
          default: '',
          title: 'TLOT',
          description: "Targeted Level of Trust: Expected level of trust as defined by ISO/IEC 27034, selected from your organization's ASC Library levels of trust",
        },
      ...
      items: {
        ...
        properties: {
          ...
          businessAssetRef: {
            ...
            description: 'Represents what makes value for the Customer. It can be information (sensitive data) or services (use case of the project)',
          },
          supportingAssetRef: {
            type: ['integer', 'null'],
            default: null,
        ...
        properties: {
          ...
          vulnerabilityFamily: {
            ...
            enum: [
              ...
              'Certificate Key Management Vulnerability',
