...
const jsonSchema = {
  ...
  description: 'THALES GROUP CONFIDENTIAL {PROJECT}',
  properties: {
    ISRAmeta: {
      type: 'object',
      properties: {
        ...
        latestBusinessAssetId: { type: ['integer', 'null'], default: 1, minimum: 1, description: 'Latest businessAssetId between sessions' },
        latestSupportingAssetId: { type: ['integer', 'null'], default: 1, minimum: 1, description: 'Latest supportingAssetId between sessions' },
        latestRiskId: { type: ['integer', 'null'], default: 1, minimum: 1, description: 'Latest riskId between sessions' },
        latestVulnerabilityId: { type: ['integer', 'null'], default: 1, minimum: 1, description: 'Latest vulnerabilityId between sessions' },
      },
    },
