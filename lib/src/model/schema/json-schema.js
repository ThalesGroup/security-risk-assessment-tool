  ...
  properties: {
    ...
    SupportingAsset: {
      ...
      items: {
        ...
        properties: {
          supportingAssetId: {
            type: ['integer', 'null'], default: null, title: 'Id', minimum: 0,
          },
    ...
    Risk: {
      ...
      items: {
        type: 'object',
        properties: {
          riskId: { type: ['integer', 'null'], default: null, minimum: 0 },
          ...
          riskAttackPaths: {
            ...
            items: {
              ...
              properties: {
                riskIdRef: { type: ['integer', 'null'], default: null, minimum: 0 },
                riskAttackPathId: { type: ['integer', 'null'], default: null, minimum: 0 },
                vulnerabilityRef: {
                  type: 'array',
                  default: [],
                  items: {
          ...
          riskMitigation: {
            ...
            items: {
              ...
              properties: {
                riskIdRef: { type: ['integer', 'null'], default: null, minimum: 0 },
                riskMitigationId: { type: ['integer', 'null'], default: null, minimum: 0 },
                description: {
                  type: 'string',
                  format: 'htmlString',
                  default: '',
    ...
    Vulnerability: {
      ...
      items: {
        ...
        properties: {
          ...
          vulnerabilityId: { type: ['integer', 'null'], default: null, minimum: 0 },
          vulnerabilityName: {
            type: 'string',
            default: '',
