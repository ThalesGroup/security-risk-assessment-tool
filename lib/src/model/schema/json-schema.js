  ...
  properties: {
    ISRAmeta: {
      ...
      properties: {
        ...
        latestBusinessAssetId: { type: ['integer', 'null'], default: 0, description: 'Latest businessAssetId between sessions' },
        latestSupportingAssetId: { type: ['integer', 'null'], default: 0, description: 'Latest supportingAssetId between sessions' },
        latestRiskId: { type: ['integer', 'null'], default: 0, description: 'Latest riskId between sessions' },
        latestVulnerabilityId: { type: ['integer', 'null'], default: 0, description: 'Latest vulnerabilityId between sessions' },
      },
    },
