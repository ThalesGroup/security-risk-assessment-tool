      ...
      items: {
        ...
        properties: {
          ...
          isTransferredFromDependency: {
            type: ['boolean'],
            default: false,
            description: 'Verifies if risk is transferred from a dependency',
          },
          dependencyOrigin: {
            type: 'string',
            default: '',
            title: 'Comment for its origin / Dependency Name',
            description: 'The name or description of the dependency this risk was transferred from',
          },
          riskLikelihood: {
            type: 'object',
            default: {},
