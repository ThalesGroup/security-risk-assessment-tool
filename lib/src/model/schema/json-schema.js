...
const jsonSchema = {
  ...
  properties: {
    ISRAmeta: {
      type: 'object',
      properties: {
        appVersion: { type: 'string', default: '', title: 'App Version' },
    ...
    BusinessAsset: {
      ...
      items: {
        type: 'object',
        properties: {
          businessAssetId: { type: ['integer', 'null'], default: null },
          businessAssetName: {
            type: 'string',
            default: '',
            title: 'Name',
    ...
    SupportingAsset: {
      ...
      items: {
        type: 'object',
        properties: {
          supportingAssetId: { type: ['integer', 'null'], default: null, title: 'Id' },
    ...
    Risk: {
      ...
      items: {
        type: 'object',
        properties: {
          riskId: { type: ['integer', 'null'], default: null },
                ...
                vulnerabilityRef: {
                  ...
                  items: {
                    ...
                    properties: {
                      ...
                      score: { type: ['integer', 'null'], default: null },
          ...
          inherentRiskScore: { type: ['integer', 'null'], default: null },
          riskMitigation: {
            type: 'array',
            default: [],
    ...
    Vulnerability: {
      ...
      items: {
        ...
        properties: {
          ...
          vulnerabilityId: { type: ['integer', 'null'], default: null },
          vulnerabilityName: {
            type: 'string',
            default: '',
