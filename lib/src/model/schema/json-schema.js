    ...
    ISRAmeta: {
      ...
      properties: {
        ...
        businessAssetsCount: {
          type: ['integer', 'null'],
          default: 0,
          description: 'Number of existing business asset(s)',
        },
        supportingAssetsCount: {
          type: ['integer', 'null'],
          default: 0,
          description: 'Number of existing supporting asset(s)',
        },
        risksCount: {
          type: ['integer', 'null'],
          default: 0,
          description: 'Number of existing risk(s)',
        },
        vulnerabilitiesCount: {
          type: ['integer', 'null'],
          default: 0,
          description: 'Number of existing vulnerabilitie(s)',
        },
        latestBusinessAssetId: { type: ['integer', 'null'], default: null, description: 'Latest businessAssetId between sessions' },
        latestSupportingAssetId: { type: ['integer', 'null'], default: null, description: 'Latest supportingAssetId between sessions' },
        latestRiskId: { type: ['integer', 'null'], default: null, description: 'Latest riskId between sessions' },
        latestVulnerabilityId: { type: ['integer', 'null'], default: null, description: 'Latest vulnerabilityId between sessions' },
      },
    },
    ...
    Risk: {
      ...
      items: {
        ...
        properties: {
          ...
          projectVersion: { type: 'string', default: '' },
            ...
            properties: {
              ...
              occurrence: {
                ...
                anyOf: [
                  ...
                  {
                    const: 5,
                    title: 'Medium (it already happened in similar organizations)',
                  },
                  {
                    const: 7,
                    title: 'High (it already happened in this organization and similar organizations)',
                  },
                  {
                    const: 9,
              ...
              properties: {
                ...
                vulnerabilityRef: {
                  ...
                  items: {
                    type: 'object',
                    properties: {
                      vulnerabilityId: { type: ['integer', 'null'] },
                      score: {
                        type: ['integer', 'null'],
                        default: null,
                      },
                    ...
                    required: ['score', 'name', 'vulnerabilityId'],
                  },
                },
                attackPathName: {
                  type: 'string',
        ...
        properties: {
          ...
          vulnerabilityFamily: {
            ...
            enum: ['', 'API Abuse', 'Authentication Vulnerability', 'Authorization Vulnerability',
              ...
              'Environmental Vulnerability', 'Error Handling Vulnerability', 'Fixed Assets Related Vulnerability',
              'General Logic Error Vulnerability', 'Input Validation Vulnerability', 'Logging and Auditing Vulnerability',
              'Password Management Vulnerability', 'Path Vulnerability', 'Personnel Related Vulnerability',
              'Protocol Errors', 'Range and Type Error Vulnerability', 'Sensitive Data Protection Vulnerability',
              'Services/Process Vulnerability', 'Session Management Vulnerability', 'Synchronization and Timing Vulnerability',
              'Unsafe Mobile Code', 'Use of Dangerous API', 'Certificate Key Management Vulnerability'],
          },
