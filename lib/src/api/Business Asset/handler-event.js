...
const addBusinessAsset = (israProject, win) => {
  try {
    ...
    return dialog.showMessageBox(currentWin, { message: 'Failed to add business asset' });
  }
};
...
const deleteBusinessAsset = (israProject, ids, win) => {
  try {
    ...
    console.log(err)
    dialog.showMessageBox(currentWin, { message: 'Failed to delete business asset(s)' });
  }
};
...
const validateBusinessAsset = (israProject, data) => {
  try {
    ...
    dialog.showMessageBox(currentWin, { message: 'Failed to validate Business Assets tab' });
  }
};
...
const updateBusinessAsset = (ISRAproject, win, id, field, value) => {
  try {
    ...
    dialog.showMessageBox(currentWin, { message: `Failed to update business asset ${id}` });
  }
};
