...
const renderBusinessAssets = () => {
  ...
  <section id="business-asset-section">
    ...
    <article>
      ...
      <div class="business-assets__criticality-guidance">
        <p>Business Assets criticality guidelines</p>
        <ul>
          <li><span>N/A:</span> Security property is not applicable to this asset.</li>
          <li><span>Low:</span> Impact is limited and normal operations can continue with minor disruption.</li>
          <li><span>Medium:</span> Impact is significant and may affect a business process, users, or service quality.</li>
          <li><span>High:</span> Impact is major and may cause serious business, financial, legal, or operational consequences.</li>
          <li><span>Critical:</span> Impact is severe and may stop an essential business activity or cause unacceptable harm.</li>
        </ul>
      </div>
    </article>
    <div class="business-assets-filter">
      <label for="business-assets__risk-filter">Risk association</label>
      <select id="business-assets__risk-filter">
        <option value="both">Both</option>
        <option value="without">Without risks</option>
        <option value="with">With risks</option>
      </select>
    </div>
