...
const DataLoad = (israProject, filePath) => new Promise((resolve, reject) => {
  ...
  fs.readFile(filePath, 'utf8', (err, data) => {
    ...
    try {
      ...
      if (typeof jsonData.Risk[0].riskName != 'string') {
      ...
      // To replace with comparison
      const vulnerabilityRefs = jsonData.Risk[0].riskAttackPaths[0].vulnerabilityRef;
      if (vulnerabilityRefs) {
        if (vulnerabilityRefs[0].rowId) {
