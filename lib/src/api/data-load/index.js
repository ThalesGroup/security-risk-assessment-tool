  ...
  // read contents of file
    ...
    try {
      ...
      if (password){
        ...
        if (jsonData.ISRAEncryptionMeta.securityVersion!=1) {
          throw Error(`Unable to load security version ${jsonData.ISRAEncryptionMeta.securityVersion}, this version only supports 1`)
        }
      }
