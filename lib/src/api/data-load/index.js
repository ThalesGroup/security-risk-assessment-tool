...
const cleanupVulnerabilitySupportingAssets = require('../xml-json/alter-isra/cleanup-vulnerability-refs.js');
...
const DataLoad = (filePath) => {
  try {
    ...
    jsonData.Vulnerability.forEach((vulnerability) => {
      ...
      vulnerability.vulnerabilityTrackingURI = sanitizeTrackingURI(
