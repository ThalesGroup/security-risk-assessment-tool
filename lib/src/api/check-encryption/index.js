...
const validateEncryptedJSONschema = require('../xml-json/validate-encrypted-json-schema');
/**
...
const IsEncrypted = (filePath) => {
  // read contents of file
    ...
    try {
      ...
      if ('ISRAEncryptionMeta' in jsonData){
        const validJSONData = validateEncryptedJSONschema(jsonData);
        if (validJSONData) return true
      }
      return false
    } catch (error) {
