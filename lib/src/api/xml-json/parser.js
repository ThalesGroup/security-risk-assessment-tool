...
/**
  * Parses imported ISRA XML into JSON using xml2js, and populates class attributes
  * @module XML2JSON
...
const parser = (xml) => ((xmlCopy) => {
  ...
  parseString(
    ...
    (xmlErr, result) => {
       ...
       * @function alterISRA
       * @param {object} ISRA - israMeta JSON that has been parsed
       * @param {string} xmlDAta - content of xml file
       ...
       * @param {object} israJSONData - edited ISRA JSON data
       ...
       * */
         ...
         * @param {object} israValidJSONData - valid ISRA JSON data
