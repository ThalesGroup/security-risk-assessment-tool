...
const alterRisks = (xmlData, risks) => ((xmlDataCopy, risksCopy) => {
  if (Array.isArray(risksCopy)) {
    ...
    const riskMitigationCounter = utilityGlobal().counter();
      ...
      if (Mitigation !== undefined) {
        ...
        r.riskMitigation = Mitigation.map((rm) => {
          ...
          const obj = {
            riskIdRef: riskId,
            riskMitigationId,
            description: utility().getHTMLString(xmlDataCopy, 'description', riskMitigationCounter.getCount()),
            decisionDetail: utility().getHTMLString(xmlDataCopy, 'decisionDetail', riskMitigationCounter.getCount()),
