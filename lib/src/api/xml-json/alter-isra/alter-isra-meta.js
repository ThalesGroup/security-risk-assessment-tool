...
const alterISRAmeta = (israMeta) => {
  ...
  meta[0].latestBusinessAssetId = businessAssetsCount;
  meta[0].latestSupportingAssetId = supportingAssetsCount;
  meta[0].latestRiskId = risksCount;
  meta[0].latestVulnerabilityId = vulnerabilitiesCount;
  return meta;
};
