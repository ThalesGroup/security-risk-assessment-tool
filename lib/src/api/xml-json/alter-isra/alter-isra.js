...
const alterISRA = (israJSONData, xmlData) => ((israJSONDataCopy, xmlDataCopy) => {
  ...
  alterSupportingAssets(israJSONDataCopy.SupportingAsset);
  alterRisks(xmlDataCopy, israJSONDataCopy.Risk);
...
// const alterISRA = async (israJSONData, xmlData) => {
//   const israJSON = israJSONData;

//   await Promise.all([
//     alterISRAmeta(israJSONData.ISRAmeta),
//     alterProjectContext(xmlData, israJSONData.ProjectContext),
//     alterBusinessAssets(xmlData, israJSONData.BusinessAsset),
//     alterSupportingAssets(israJSONData.SupportingAsset),
//     alterRisks(xmlData, israJSONData.Risk),
//     alterVulnerability(xmlData, israJSONData.Vulnerability),
//   ]);

//   israJSON.ISRAmeta = israJSON.ISRAmeta.pop();
//   israJSON.ProjectContext = israJSON.ProjectContext.pop();
//   israJSON.SupportingAssetsDesc = getHTMLString(xmlData, 'supportingAssetDiagram');
//   return israJSON;
// };
