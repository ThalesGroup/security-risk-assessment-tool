...
/** modify parsed ISRA JSON to fit schema
       ...
       * */
const alterISRA = (israJSONData, xmlData, sanitizationReport) => ((israJSONDataCopy, xmlDataCopy) => {
  ...
  alterVulnerability(xmlDataCopy, israJSONDataCopy.Vulnerability, sanitizationReport);
