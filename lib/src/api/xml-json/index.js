...
const cleanupVulnerabilitySupportingAssets = require('./alter-isra/cleanup-vulnerability-refs');
...
const XML2JSON = (filePath) => {
  ...
  const vulnerabilitySupportingAssetCleanup = cleanupVulnerabilitySupportingAssets(israJSONData);
