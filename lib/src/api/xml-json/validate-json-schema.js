...
const validateJsonSchema = (data) => {
  const schemaForValidation = jsonSchema
  delete schemaForValidation.properties.ProjectContext.properties.projectDescriptionAttachment;
  const validate = ajvInstance.compile(schemaForValidation);
