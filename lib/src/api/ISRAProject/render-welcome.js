...
const renderWelcome = () => {
  ...
  <article id="welcome__isra-meta-info">
    ...
    <section>
        ...
        Represents what makes value for the Customer or Thales. It can be information (sensitive data) or services (use case of the Solution). It is directly linked to the value chain the Thales Solution aims to support, it is visible and makes sense to the Customer.
        </p>
      ...
      <p>The risk assessment takes place in 3 different situations:
        <ul>
          ...
          <li>Use-case 3: Perform SRA of a Product in customer context (reassessment)
              <ul>
                <li>An R&D Product is used without any customization, inside a datacenter operated by Thales or at Customer's premises.</li>
  ...
  const tableOptions = {
    ...
    columns: [ // Define Table Columns
      {
        title: '', field: 'Welcome Checkbox', headerSort: false, headerHozAlign: 'center', hozAlign: 'center', headerWordWrap: true,  width: 50
      },
      {
