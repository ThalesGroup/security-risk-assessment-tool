...
const renderWelcome = () => {
  ...
  <div id="welcome__isra-meta">
    ...
    <select id="welcome__isra-meta--targeted-level-of-trust" name="welcome__isra-meta--targeted-level-of-trust" title="${ISRAmetaSchema.targetedLevelOfTrust.description}" required>
  ...
  const tableOptions = {
    ...
    columns: [ // Define Table Columns
      ...
      {
        title: `${ISRATrackingSchema.trackingComment.title}`, field: 'trackingComment', editor: 'textarea', formatter: 'textarea', variableHeight: true, headerSort: false, headerTooltip: `${ISRATrackingSchema.trackingComment.description}`, headerHozAlign: 'center', cssClass: 'welcome__tracking-comment-cell',
      },
    ],
  };
