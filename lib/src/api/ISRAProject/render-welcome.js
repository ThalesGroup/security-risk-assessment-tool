...
const renderWelcome = () => {
  ...
  const tableOptions = {
    ...
    columns: [ // Define Table Columns
      ...
      {
        title: `${ISRATrackingSchema.trackingComment.title}`, field: 'trackingComment', editor: 'input', headerSort: false, headerTooltip: `${ISRATrackingSchema.trackingComment.description}`, headerHozAlign: 'center',
      },
    ],
  };
