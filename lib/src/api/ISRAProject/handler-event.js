...
const addTrackingRow = (israProject) => {
  try {
    ...
    return dialog.showMessageBox(currentWin, { message: 'Failed to add iteration row' });
  }
};
...
const deleteTrackingRow = (israProject, iterations) => {
  try {
    ...
    return dialog.showMessageBox(currentWin, { message: 'Failed to delete iteration row(s)' });
  }
};
...
const updateTrackingRow = (israProject, rowData) => {
  try {
    ...
    dialog.showMessageBox(currentWin, { message: `Failed to update iteration row ${rowData.trackingIteration}` });
  }
};
...
const updateProjectNameAndVersionRef = (israProject, field, value) => {
  try {
    ...
    dialog.showMessageBox(currentWin, { message: `Failed to update project name/version of Risk/Vulnerability` });
  }
};
...
const validateISRAmeta = (israProject, data) => {
  try {
    ...
    dialog.showMessageBox(currentWin, { message: 'Failed to validate Welcome tab' });
  }
};
