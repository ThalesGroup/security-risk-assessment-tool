...
const deleteVulnerabilityRef = (israProject, riskId, riskAttackPathId, rowIds, win) => {
    try {
        ...
        dialog.showMessageBoxSync(getMainWindow(), { message: `Failed to delete Risk Attack Path ${riskAttackPathId}'s rowId: ${rowId} for Risk ${riskId}` });
    }
};
