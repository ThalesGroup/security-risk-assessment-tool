...
*/
// const calculateRiskMitigationScore = (risk) => {
//     const { riskMitigation } = risk.properties;

//     riskMitigation.forEach((mitigation) => {
//         const { riskMitigationId, benefits, decision } = mitigation;
//         if(decision === 'Accepted' || decision === 'Done') {
//             const selectedMitigation = risk.getRiskMitigation(riskMitigationId);
//             selectedMitigation.mitigationsBenefits = 1 - benefits;
//             if(decision === 'Done'){
//                 selectedMitigation.mitigationsDoneBenefits = 1 - benefits;
//             }
//         }
//     });
// }
...
*/
const deleteRiskMitigation = (israProject, riskId, ids) => {
    try {
        const risk = israProject.getRisk(riskId);
        ids.forEach((id) => {
...
const updateRiskMitigation = (israProject, riskId, riskMitigationId, field, value) => {
    try {
        const riskMitigation = israProject.getRisk(riskId).getRiskMitigation(riskMitigationId);
        console.log(value)
        console.log(typeof value)
        riskMitigation[field] = value;
        
        console.log(riskMitigation.properties)
        // return israProject.properties.Risk;
    } catch (err) {
        console.log(err)
