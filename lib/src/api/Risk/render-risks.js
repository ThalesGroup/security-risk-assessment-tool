        ...
        <section id="risk__automatic_riskname">
            ...
            <div class="risk__flex">
                <div>
                    ...
                    <select id="risk__threatAgent" name="risk__threatAgent" title="${riskJsonSchema.threatAgent.description}">
                        ${threatAgentOptions}
                    </select>
                ...
                <div>
                    ...
                    <select id="risk__threat" name="risk__threat" title="${riskJsonSchema.threatVerb.description}">
                        ${threatVerbOptions}
                    </select>
            ...
            <div class="risk__flex">
                <div>
                    ...
                    <select id="risk__businessAsset" name="risk__businessAsset" title="${riskJsonSchema.businessAssetRef.description}"></select>
                </div>
                <div>
                    <label for="risk__supportingAsset">Compromising the <span>Supporting Asset</span></label>
                    <select id="risk__supportingAsset" name="risk__supportingAsset" title="${riskJsonSchema.supportingAssetRef.description}"></select>
                </div>
            </div>
            ...
            <div>
                <div style="display: flex; flex-direction: column;">
                    ...
                    <input type="text" name="risk__motivation" id="risk__motivation" title="${riskJsonSchema.motivation.description}">
