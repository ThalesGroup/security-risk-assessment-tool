...
const renderRisks = () => {
  ...
  const html = `
    ...
    <div class="add-delete-container">
        <button class="addDelete">Add</button> | <button id="risks__delete__button" class="addDelete">Delete</button> | <button id="risks__clone__button" class="addDelete">Clone</button>
    </div>
    ...
    <section id="risks__risk__evaluation">
        ...
        <div id="risks__vulnerability__evaluation">
            ...
            <h1 style="text-align: center;">Inherent Risk Score: <span id="inherent_risk_score"></span>/20 <span id="inherent_risk_level" style="font-weight: bold;"></span></h1>
    </section>
    <section id="risks__risk__mitigation__evaluation">
        ...
        <h1 style="text-align: center;">${riskJsonSchema.mitigatedRiskScore.title}: <span id="mitigated_risk_score"></span>/20 <span id="mitigated_risk_level" style="font-weight: bold;"></span></h1>
  ...
  const tableOptions = {
    ...
    columns: [ // Define Table Columns
      {
        title: 'Select', field: 'Risk Checkbox', headerSort: false, headerHozAlign: 'center', hozAlign: 'center', headerWordWrap: true, width: 80
      },
      {
