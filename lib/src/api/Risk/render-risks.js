...
const renderRisks = () => {
  ...
  const tableOptions = {
    ...
    columns: [ // Define Table Columns
      ...
      {
        title: 'Risk Level', field: 'residualRiskLevel', headerSort: false, headerHozAlign: 'center',
      },
      {
        title: 'Management Decision', field: 'riskManagementDecision', headerSort: false, headerHozAlign: 'center',
      },
    ],
  };
