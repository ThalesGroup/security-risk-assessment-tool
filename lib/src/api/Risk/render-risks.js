...
const renderRisks = () => {
  ...
  const html = `
    ...
    <div class="risks-sort-row">
        <div class="risks-filter__sort">
                ...
                <select id="sort-risk">
                    <option value="id-asc" selected>Risk ID</option>
    ...
    <section id="risks__risk__evaluation">
        ...
        <div id="risks__vulnerability__evaluation">
            ...
            <h1 style="text-align: center;">Inherent Risk Score: <span id="inherent_risk_score"></span></h1>
        </div>
    </section>
    <section id="risks__risk__mitigation__evaluation">
        ...
        <h1 style="text-align: center;">${riskJsonSchema.mitigatedRiskScore.title}: <span id="mitigated_risk_score"></span></h1>
  ...
  const tableOptions = {
    ...
    columns: [ // Define Table Columns
      ...
      {
        title: 'Risk Id', field: 'riskId', width: 20, headerSort: false, sorter: 'number', headerHozAlign: 'center', hozAlign: 'center', headerWordWrap: true
      },
      {
