  ...
  const html = `
    ...
    <section id="risks__risk__evaluation">
        ...
        <div id="risks__vulnerability__evaluation">
            ...
            <h1 style="text-align: center;">Inherent Risk Level: <span id="inherent_risk_level"></span></h1>
    </section>
    <section id="risks__risk__mitigation__evaluation">
        ...
        <h1 style="text-align: center;">Mitigated Risk Level: <span id="mitigated_risk_level"></span></h1>
