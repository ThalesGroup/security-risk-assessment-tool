...
contextBridge.exposeInMainWorld('risks', {
  ...
  isAutomaticRiskName: (riskName, allAttackPathsName) => ipcRenderer.invoke('risks:isAutomaticRiskName', riskName, allAttackPathsName),
  // isOWASPRiskLikelihood: (riskLikelihood) => ipcRenderer.invoke('risks:isOWASPRiskLikelihood', riskLikelihood)
});

contextBridge.exposeInMainWorld('vulnerabillities', {
  addVulnerability: () => ipcRenderer.invoke('vulnerabillities:addVulnerability'),
  deleteVulnerability: (ids) => ipcRenderer.send('vulnerabillities:deleteVulnerability', ids),
});
