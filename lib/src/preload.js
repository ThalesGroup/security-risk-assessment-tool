...
contextBridge.exposeInMainWorld('risks', {
  ...
  getBusinessAssets: (label, value) => ipcRenderer.on('risks:getBusinessAssets', label, value),
  getSupportingAssets: (label, value) => ipcRenderer.on('risks:getSupportingAssets', label, value)
});
