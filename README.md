...
2. Define the Targeted Level of Trust (TLoT) for the project. The TLoT represents the level of confidence required in the application’s security, according to ISO/IEC 27034. A TLoT of 1 represents the lowest required level of trust, while higher values indicate a greater level of security assurance.
