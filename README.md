...
8. For those risks that need to be treated determine how they will be treated:
  * Modify or Mitigate: propose the security controls to put into place in the risks tab for each risk that needs to be treated and level of reduction of risk if security control is implemented.
